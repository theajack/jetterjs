var apiData = {
    ...
    title: ".clk()",
		...
		intro: "Set tip",
		test: true,
		function :"Set tip of one or many elements",
	...
	Serialize: [{
		...
		howUse: "Parameter:HTMLElement|String,[Json|FormData][Function|String][String]",
		code: '<div jet-form="test">\n\t<input type="text" jet-name="name value"/>\n\t<input type="text" jet-name="password attr:test"/>\n\t<input type="text" jet-name="color css:background-color"/>\n</div>\n<input type="button" value="set values" onclick="setTest()"/>\n<div id="show"></div>\n<script>\nfunction setTest(){\n\tvar info={\n\t\tname:"name test",\n\t\tpassword:"password test",\n\t\tcolor:"red"\n\t};\n\tJ.set("test",info,null,"jet-name");//jet-name is default\n\tJ.id("show").txt(J.jetForm("test").html());\n}\n</script>'
  }, {
		title: "J.clear()",
		intro: "Clear values",
		test: true,
