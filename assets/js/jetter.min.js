...
HTMLElement.prototype.slideUp = function(a, b, c) {
	return j_checkSlideHeight(this, a, b, c,false)
};
HTMLElement.prototype.slideDown = function(a, b, c) {
	if (this.hasClass("j-fade")) {
		this.removeClass("j-fade").addClass("j-slide")
	};
	return j_checkSlideHeight(this, a, b, c,true)
};
HTMLElement.prototype.slideToggle = function(a, b, c) {
	if (this.hasClass("j-fade")) {
		this.removeClass("j-fade").addClass("j-slide")
	}
	return j_checkSlideHeight(this, a, b, c)
};
function j_checkSlideHeight(obj,a, b, c,d){
  if(obj.style.height==""){
    obj.css("height",obj.css("height"));
    setTimeout(function(){
      j_animateBase(obj, "j-slide", a, b, c,d)
    },50);
  }else{
    j_animateBase(obj, "j-slide", a, b, c,d)
  }
